...
const BlogCard = ({ blog }) => {
    return (
        <Link href={`/blog/${blog._id}`} className='flex gap-2 w-full h-52 p-1 rounded-md shadow-md bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] justify-between border-b-2 border-slate-500 border-opacity-10'>
